...
## Як запустити проект?
1 - Завантажте всі файли zip :file_folder:
2 - Розархівіруйте їх
3 - Файл bot_run.bat винесіть на робочий стіл :open_file_folder:
4 - Відкривайте телеграмм та файл bot_run.bat
5 - Шукайте бота чи групу, назви однакові - WOK_noodles_and_rice
6 - Пишіть команду /start
